...
public class Config {
    ...
    public Config() throws IOException {
        ...
        FileInputStream fis = new FileInputStream(new File("C:\\Users\\sifk\\IdeaProjects\\Workspace\\escape-game\\src\\main\\java\\jeuplusoumoins\\resources\\config.properties"));
